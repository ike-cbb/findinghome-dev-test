...
function ShareArticle() {
  return (
    ...
    >
      <p style={{ marginBottom: 0 }}>Share This</p>
...
export default function GuidePage() {
  return (
    <article
      className="ContentWrapper_content__16TR9"
      style={{
        maxWidth: "620px",
        margin: "0 auto",
        lineHeight: "1.6875",
    ...
    >
      ...
      >
        <Image
          ...
          style={{ filter: "brightness(0.6)", padding: "0 5%", }}
          priority
        />
      </div>
      ...
      >
        <div
          className="mx-auto"
          style={{ maxWidth: "1000px", display: "flex", flexDirection: "column", gap: "30px" }}
        >
          <ShareArticle />
