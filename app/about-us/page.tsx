            ...
            <div className="relative bg-[#fde2e1]" style={{ padding: "50px 60px" }}>
              ...
              <form style={{ marginTop: "40px", marginBottom: "40px" }}>
                ...
                <div style={{ marginBottom: "15px" }}>
                  <input type="checkbox" required aria-required="true" id="checkbox-agree-about"
                    name="checkbox-agree-about"
                  ...
                  <label htmlFor="checkbox-agree-about" className="text-[#000] cursor-pointer" style={{ lineHeight: "1.5" }}>
