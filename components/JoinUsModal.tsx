  ...
  return (
    <>
      <button
        ...
        className="inline-block w-full text-center rounded-[3px] bg-[#fde2e1] text-[#ef4136] text-[18px] px-10 py-[15px] font-medium no-underline hover:bg-[#f5d0cf] transition-colors cursor-pointer"
      >
        Join Us
      </button>
      ...
      {open && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="join-us-modal-title"
        >
          <div
          ...
          >
            ...
            <form name="join-us-modal-form" encType="multipart/form-data">
              <input
                type="text"
              ...
              <div style={{ marginBottom: "20px", marginTop: "5px" }}>
                <input
                  ...
                  required
                  aria-required="true"
                  id="checkbox-agree-joinus"
                  name="checkbox-agree-joinus"
